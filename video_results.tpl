                    ...
                    <div class="col-md-10 col-xs-8">
                        ...
                        <div class="input-group">
                            <div id="search_opt_list" class="input-group-btn">
                                ...
                                <button id="toggle_video_search" type="button" class="btn btn-lg btn-primary search_opt"><i class='fa fa-check'></i> Video</button>
                            </div>
                            <input id="search_input" type="text" name="video_keywords" class="form-control" value="{{queryInput}}">
                        </div>
                    </div>
                    </div>
